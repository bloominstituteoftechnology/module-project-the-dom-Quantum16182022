function moduleProject1() {
 ...
 widget.setAttributes(' tabindex', idx + 1)
...
authorDate.textContent = `${author} in ${date || "as unknown date"}`
  ...
  const mumboJumbo = `We need to ${randomVerb1} our ${randomNoun1} ${randomAdverb1} in order to ${randomVerb2} our ${randomNoun2} ${randomAdverb2}.`
    ...
    document.querySelector('.corporatespeake').appendChild(paragraph)
  ...
  count.textContent = `T-minus ${count}`
...
personParagraph.textContent = sentence
  ...
  //  ✨ add let widgets = document.querySelectorAll('.widget');
